<h2><a href="https://www.geeksforgeeks.org/problems/minimum-time1238/1?_gl=1*v4xs09*_up*MQ..&gclid=CjwKCAiAhqCdBhB0EiwAH8M_GoC4dHdy1Y8GWzmsRI77twRorT41-V4Tcl_M0MJ9Slc_sILYztk6PRoCyegQAvD_BwE">Minimum Cost for n Characters</a></h2><h3>Difficulty Level : Difficulty: Medium</h3><hr><div class="problems_problem_content__Xm_eO" style="--text-color: var(--problem-text-color);"><p><span style="font-size: 18px;">Given four integers <strong>n</strong>, <strong>i</strong>, <strong>d</strong>, and <strong>c</strong>, where:</span></p>
<ul>
