<h2><a href="https://www.geeksforgeeks.org/problems/count-the-subset-with-sum-equal-to-k/1?_gl=1*1qmrijw*_up*MQ..&gclid=CjwKCAiAhqCdBhB0EiwAH8M_GoC4dHdy1Y8GWzmsRI77twRorT41-V4Tcl_M0MJ9Slc_sILYztk6PRoCyegQAvD_BwE">Count Subset With Target Sum II</a></h2><h3>Difficulty Level : Difficulty: Medium</h3><hr><div class="problems_problem_content__Xm_eO"><p><span style="font-size: 18px;">Given an array <strong>arr[]</strong> and an integer <strong>k</strong>, find the count of <strong>subsets</strong> whose sum is equals to k.</span></p>
