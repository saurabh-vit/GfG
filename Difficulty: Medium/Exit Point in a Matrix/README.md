<h2><a href="https://www.geeksforgeeks.org/problems/exit-point-in-a-matrix0905/1?_gl=1*6taf2g*_up*MQ..&gclid=CjwKCAiAhqCdBhB0EiwAH8M_GoC4dHdy1Y8GWzmsRI77twRorT41-V4Tcl_M0MJ9Slc_sILYztk6PRoCyegQAvD_BwE">Exit Point in a Matrix</a></h2><h3>Difficulty Level : Difficulty: Medium</h3><hr><div class="problems_problem_content__Xm_eO" style="--text-color: var(--problem-text-color);"><p><span style="font-size: 18px;">Given a matrix mat[][] of size <strong>n</strong> × <strong>m </strong>consisting of <strong>0</strong>s and <strong>1</strong>s. You start at the top-left cell (0, 0) and initially move in the left-to-right direction (i.e., towards the right).</span></p>
