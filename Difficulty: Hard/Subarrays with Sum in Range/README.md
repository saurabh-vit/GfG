<h2><a href="https://www.geeksforgeeks.org/problems/count-the-number-of-subarrays/1?_gl=1*1ne191*_up*MQ..&gclid=CjwKCAiAhqCdBhB0EiwAH8M_GoC4dHdy1Y8GWzmsRI77twRorT41-V4Tcl_M0MJ9Slc_sILYztk6PRoCyegQAvD_BwE">Subarrays with Sum in Range</a></h2><h3>Difficulty Level : Difficulty: Hard</h3><hr><div class="problems_problem_content__Xm_eO" style="--text-color: var(--problem-text-color);"><p><span style="font-size: 18px;">Given an integer array <strong>arr[]</strong> and two integers <strong>l</strong> and <strong>r</strong>, find the number of subarrays whose sum lies in the range [l, r] (inclusive).</span></p>
