<h2><a href="https://www.geeksforgeeks.org/problems/adventure-in-a-maze2051/1?_gl=1*1b00cds*_up*MQ..&gclid=CjwKCAiAhqCdBhB0EiwAH8M_GoC4dHdy1Y8GWzmsRI77twRorT41-V4Tcl_M0MJ9Slc_sILYztk6PRoCyegQAvD_BwE">Adventure in a Maze</a></h2><h3>Difficulty Level : Difficulty: Hard</h3><hr><div class="problems_problem_content__Xm_eO" style="--text-color: var(--problem-text-color); --darkreader-text--text-color: var(--darkreader-text--problem-text-color); --darkreader-border--text-color: var(--darkreader-border--problem-text-color);"><p><span style="font-size: 14pt;">Given a maze represented as an <strong>n x n</strong> grid, <strong>grid[][]</strong>, using 0-based indexing. Each cell contains one of the values 1, 2, or 3, which determines the direction(s) you are allowed to move from that cell:</span></p>
<ul>
