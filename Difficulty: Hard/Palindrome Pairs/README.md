<h2><a href="https://www.geeksforgeeks.org/problems/palindrome-pairs/1?_gl=1*ziqy53*_up*MQ..&gclid=CjwKCAiAhqCdBhB0EiwAH8M_GoC4dHdy1Y8GWzmsRI77twRorT41-V4Tcl_M0MJ9Slc_sILYztk6PRoCyegQAvD_BwE">Palindrome Pairs</a></h2><h3>Difficulty Level : Difficulty: Hard</h3><hr><div class="problems_problem_content__Xm_eO" style="--text-color: var(--problem-text-color);"><p><span style="font-size: 18px;">Given&nbsp;</span><span style="font-size: 18px;">an array <strong>arr[]</strong> consisting of <strong>n </strong>strings. Determine whether there exists a pair of indices <strong>(i, j) </strong>such that <strong>i ≠ j </strong>and the concatenation <strong>arr[i] + arr[j]</strong> forms a palindrome.</span></p>
